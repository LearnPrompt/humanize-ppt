#!/usr/bin/env python3
"""Humanize PPT v0.7.0 — 演讲 QA 大纲 (audience state-transfer map).
...
def main(argv=None):
    ap = argparse.ArgumentParser(
        description="Humanize PPT v0.7.0 — render a zero-dependency audience state-transfer map from slide_plan.json"
    )
